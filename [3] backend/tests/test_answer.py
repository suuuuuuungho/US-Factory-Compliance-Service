...
from app.answer import TOP_N, answer_question
from app.index import Index
from ecfr_keyword import build_keyword_search

# 조문 12개(subpart PPPP 6개, subpart M 6개). 질문 "solvent welding"은 63.4481과 BM25로 맞는다
...
CHUNKS = [
    ...
    for i, (sec, sp) in enumerate(SECTIONS)
]
...
def make_index():
    return Index("rel-1", CHUNKS, build_keyword_search(CHUNKS))

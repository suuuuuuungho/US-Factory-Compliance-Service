...
- 원본에 있던 **가짜 날짜**(1900년 전, 2100년 후. 예: `0001-01-01`, `8888-01-01`, 오타 `0215-11-02`) 106개는 2026-09-24에 **빈값으로 바꿨어요**. 원래 글자는 `raw_date` / `raw_dates`에 남아 있어요. 지금 `activity_date` 빈값은 6,321건이에요.
  - 다시 적재하면 또 들어와요. 적재 코드는 SUU-270에서 고쳐요.

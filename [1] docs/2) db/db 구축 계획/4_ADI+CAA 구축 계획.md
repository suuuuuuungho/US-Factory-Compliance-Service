...
7) 1-5. 수집 결과
   ...
   - 2026-09-17 실제 수집(SUU-114): ADI 목록 3,825 · ADI 상세 3,813/3,825 · Dashboard 목록 236(Part 63 132) · Dashboard PDF 229/230(404 1건) · ADI PDF 469/469(Part 63 후보 1,005건 중 2005년 이후만). ADI 분류: MACT 762 · NESHAP 316 · GACT 4 · NSPS 2,417 · Asbestos 270. 상세는 `[5] tickets/1)DB/3_chore/SUU-114.md`.
   - 2005년 이전 ADI PDF 536건은 미수집(스캔본, 3MB·19초/건). ADI와 Dashboard 사이의 실제 중복 수, 최종 Part 63 관련 문서 수는 미확정이다.

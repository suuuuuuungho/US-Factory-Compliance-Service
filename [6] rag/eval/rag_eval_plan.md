...
| A-5 ③ | Subpart A 항상 포함 | 완료(SUU-153, $2.27). `--always-a`로 63.2·63.7·63.8을 상위 10 뒤에 항상 → **0.971 / 0.785 / 1.000 / 1.755**, 실패 3. Recall 기준 0.77 통과, 지어냄 0. 입력 토큰 27k→44k/건. 남은 실패 3건은 검색이 정답 조문을 못 올린 것 |

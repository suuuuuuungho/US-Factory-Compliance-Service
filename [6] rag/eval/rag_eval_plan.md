...
- **v2 = `rag_eval_case_v2.jsonl` 102건**(SUU-120): v1 32건 + 새 70건. 새 건은 SUU-115 초안 중 근거 문장이 회신에 100% 그대로 있는 243건 → 주 Subpart당 v1 포함 2건까지 75건 → Claude가 회신 원문과 대조(70 채택, 5 제외, 15 손봄). 주 Subpart 68개. 세부: `[5] tickets/SUU-120.md`. 앞으로의 측정은 v2로 하고 v1 숫자와 섞지 않는다.
